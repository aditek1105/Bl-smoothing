...
def smoothing_pos(positive_words_dict, total_positive_count, total_words_len):
    pos_words_prob = {}
...
def smoothing_neg(negative_words_dict, total_negative_count, total_words_len):
    neg_words_prob = {}
...
def main(inputdir, output):
    ...
    neg_words_prob = smoothing_neg(negative_words_dict, total_negative_count, total_words_len)
    pos_words_prob = smoothing_pos(positive_words_dict, total_positive_count, total_words_len)
